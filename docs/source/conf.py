...
pygments_style = 'futureext.FutureStyle'
...
latex_documents = [
  ('latexindex', 'Python-Future.tex', u'Python-Future Documentation',
   u'Ed Schofield', 'manual'),
]
...
texinfo_documents = [
  ('index', 'Python-Future', u'Python-Future Documentation',
   u'Ed Schofield', 'Python-Future', 'One line description of project.',
   'Miscellaneous'),
]
