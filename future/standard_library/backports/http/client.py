...
Refactored slightly from Python 2.7 httplib.py for python-future:
* file renamed to http/client.py
* These obsolete classes have been removed:
   - HTTP
   - HTTPS
   - LineAndFileWrapper
  and the FakeSocket function.
