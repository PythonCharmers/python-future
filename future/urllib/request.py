...
from future.urllib.error import URLError, HTTPError, ContentTooShortError
from future.urllib.parse import (
    urlparse, urlsplit, urljoin, unwrap, quote, unquote,
    splittype, splithost, splitport, splituser, splitpasswd,
    splitattr, splitquery, splitvalue, splittag, to_bytes, urlunparse)
from future.urllib.response import addinfourl, addclosehook
...
_cut_port_re = re.compile(r":\d+$")  # EJS: , re.ASCII)
            ...
            if file:
                ...
                try:
                    try:
                        ...
                        exc = URLError('ftp error: %d' % reason)
